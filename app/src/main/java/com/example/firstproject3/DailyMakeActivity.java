...
public class DailyMakeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnReser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                uploadData(title, date, time, memo, category, cateText, id);
    ...
    private void uploadData(String title, String date, String time, String memo, String category, String cateText, String id) {
